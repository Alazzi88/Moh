  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundColor: "transparent", // شفافية الخلفيةلى 
        ...
        <div className="p-8 text-gray-700 leading-relaxed">
          ...
          <ul className="list-decimal list-inside space-y-6">
            <li>
              ...
              ضرورية لبناء العضلات وتحسين الأداء الرياضي. حاول تضمين مصادر بروتينية مثل اللحوم
              الخالية من الدهون، الأسماك، البيض، والبقوليات.
            </li>
            <li>
              <span className="font-semibold text-green-600">الدهون الصحية:</span>{" "}
              مثل زيت الزيتون، المكسرات، والأفوكادو. هذه الدهون تدعم صحة القلب وتساهم في تحسين مستويات
              الكوليسترول.
            </li>
            <li>
              <span className="font-semibold text-green-600">الكربوهيدرات المعقدة:</span>{" "}
              مثل الحبوب الكاملة (الشوفان، الأرز البني، الكينوا) توفر طاقة مستدامة وتساعد على تنظيم مستوى
              السكر في الدم.
            </li>
            <li>
            ...
            <li>
              ...
              شرب كميات كافية من الماء طوال اليوم يحسن الهضم ويزيد من الطاقة والتركيز.
            </li>
            <li>
              <span className="font-semibold text-green-600">الفيتامينات والمعادن:</span>{" "}
              مثل فيتامين D، المغنيسيوم، والزنك، التي تلعب دورًا هامًا في الصحة العامة وتعزيز الوظائف
              المناعية والهرمونية.
            </li>
            <li>
              <span className="font-semibold text-green-600">ممارسة النشاط البدني:</span>{" "}
              التغذية السليمة لا تكتمل بدون ممارسة التمارين الرياضية بانتظام. احرص على تضمين تمارين القوة
              والتمارين الهوائية.
            </li>
          </ul>
          <p className="mt-6 text-lg">
            التغذية السليمة تؤثر بشكل مباشر على قدرة الرجل في الحفاظ على وزنه المثالي، تعزيز قوته، وتحسين
